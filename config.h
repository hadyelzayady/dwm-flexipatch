...
#if RENAMED_SCRATCHPADS_PATCH
static const char *scratchpadcmd[] = {"$TERMINAL", "-T", "spterm", NULL};
#elif SCRATCHPADS_PATCH
const char *spcmd1[] = {"$TERMINAL", "-T", "spterm", "--position", "120x34", NULL };
...
static const Key keys[] = {
	...
	#if SHIFTVIEW_PATCH
	{ MODKEY|ControlMask|Mod1Mask,             XK_h,        shiftview,              { .i = -1 } },
	{ MODKEY|ControlMask|Mod1Mask,             XK_l,  shiftview,              { .i = +1 } },
	...
	#if SHIFTBOTH_PATCH
	{ MODKEY|ControlMask|ShiftMask|Mod1Mask,           XK_h,       shiftboth,              { .i = -1 } }, // note keybinding conflict with focusadjacenttag tagandviewtoleft placedir
	{ MODKEY|ControlMask|ShiftMask|Mod1Mask,           XK_l,      shiftboth,              { .i = +1 } }, // note keybinding conflict with focusadjacenttag tagandviewtoright placedir
